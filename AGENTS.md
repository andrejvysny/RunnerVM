...
- `GuestAgent/` — Go module `github.com/andrejvysny/RunnerVM/GuestAgent` (go 1.26, dep mdlayher/vsock); `internal/{agent,rpc,vsock,exec,runner,metrics,disk,cleanup,system}`; Makefile.
